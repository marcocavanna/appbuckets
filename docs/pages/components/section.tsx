...
const pageFilename = 'components/section';
const requireDemo = require.context('../../src/pages/components/section', false, /\.(js|tsx)$/);
const requireRaw = require.context(
  '!raw-loader!../../src/pages/components/section',
  true,
  /\.(js|md|tsx|json)$/
);

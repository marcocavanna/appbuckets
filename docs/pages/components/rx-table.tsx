...
const pageFilename = 'components/rx-table';
const requireDemo = require.context('../../src/pages/components/rx-table', false, /\.(js|tsx)$/);
const requireRaw = require.context(
  '!raw-loader!../../src/pages/components/rx-table',
  true,
  /\.(js|md|tsx|json)$/
);

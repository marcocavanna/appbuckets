...
const pageFilename = 'components/bucket-theme';
const requireDemo = require.context('../../src/pages/components/bucket-theme', false, /\.(js|tsx)$/);
const requireRaw = require.context(
  '!raw-loader!../../src/pages/components/bucket-theme',
  true,
  /\.(js|md|tsx|json)$/
);

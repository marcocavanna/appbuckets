...
const pageFilename = 'components/linear-progress';
const requireDemo = require.context('../../src/pages/components/linear-progress', false, /\.(js|tsx)$/);
const requireRaw = require.context(
  '!raw-loader!../../src/pages/components/linear-progress',
  true,
  /\.(js|md|tsx|json)$/
);

...
const pageFilename = 'components/message';
const requireDemo = require.context('../../src/pages/components/message', false, /\.(js|tsx)$/);
const requireRaw = require.context(
  '!raw-loader!../../src/pages/components/message',
  true,
  /\.(js|md|tsx|json)$/
);

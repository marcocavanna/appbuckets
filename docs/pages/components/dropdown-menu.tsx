...
const pageFilename = 'components/dropdown-menu';
const requireDemo = require.context('../../src/pages/components/dropdown-menu', false, /\.(js|tsx)$/);
const requireRaw = require.context(
  '!raw-loader!../../src/pages/components/dropdown-menu',
  true,
  /\.(js|md|tsx|json)$/
);

...
const pageFilename = 'components/multi-select';
const requireDemo = require.context('../../src/pages/components/multi-select', false, /\.(js|tsx)$/);
const requireRaw = require.context(
  '!raw-loader!../../src/pages/components/multi-select',
  true,
  /\.(js|md|tsx|json)$/
);

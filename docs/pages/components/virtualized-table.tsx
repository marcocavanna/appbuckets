...
const pageFilename = 'components/virtualized-table';
const requireDemo = require.context('../../src/pages/components/virtualized-table', false, /\.(js|tsx)$/);
const requireRaw = require.context(
  '!raw-loader!../../src/pages/components/virtualized-table',
  true,
  /\.(js|md|tsx|json)$/
);

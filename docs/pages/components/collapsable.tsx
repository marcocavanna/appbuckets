...
const pageFilename = 'components/collapsable';
const requireDemo = require.context('../../src/pages/components/collapsable', false, /\.(js|tsx)$/);
const requireRaw = require.context(
  '!raw-loader!../../src/pages/components/collapsable',
  true,
  /\.(js|md|tsx|json)$/
);

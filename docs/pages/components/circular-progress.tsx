...
const pageFilename = 'components/circular-progress';
const requireDemo = require.context('../../src/pages/components/circular-progress', false, /\.(js|tsx)$/);
const requireRaw = require.context(
  '!raw-loader!../../src/pages/components/circular-progress',
  true,
  /\.(js|md|tsx|json)$/
);

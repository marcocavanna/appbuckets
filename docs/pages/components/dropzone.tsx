...
const pageFilename = 'components/dropzone';
const requireDemo = require.context('../../src/pages/components/dropzone', false, /\.(js|tsx)$/);
const requireRaw = require.context(
  '!raw-loader!../../src/pages/components/dropzone',
  true,
  /\.(js|md|tsx|json)$/
);

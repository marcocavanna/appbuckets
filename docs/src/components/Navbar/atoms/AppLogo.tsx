...
const SvgIcon: React.FunctionComponent<{ className?: string }> = () => (
  <svg
    viewBox={'0 0 252 229'}
    fillRule={'evenodd'}
    clipRule={'evenodd'}
    ...
    height={'1em'}
  >
    <g transform={'matrix(2.03269,1.17357,-1.17357,2.03269,-178.381,-225.614)'}>
      <path
        className={'main'}
    ...
    <g transform={'matrix(2.04599,1.18125,1.18125,-2.04599,-232.05,115.322)'}>
      <path
        className={'slice-bottom-right'}
    ...
    <g transform={'matrix(1.92036,1.10872,1.85633,-3.21526,-333.559,500.351)'}>
      <path
        className={'extra-piece'}
